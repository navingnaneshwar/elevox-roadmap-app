...
const STEPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      // S5-06 additions
      { id: "targetPersona",     label: "The ONE person you most need to impress (specific role + company type)", type: "textarea", placeholder: "e.g. Managing Partner at a mid-market PE fund targeting B2B SaaS. This replaces vague 'target audience' with a real human.", required: false },
      { id: "desiredAction",     label: "What do you want them to do after 3 months of your content?", type: "select", options: ["Reach out to me directly","Invite me to speak at an event","Offer a board opportunity","Refer me to their network","Hire me / my firm","Follow and trust my POV publicly"], required: false },
      { id: "audienceOnline",    label: "Where does your target audience find thought leaders?",   type: "textarea",    placeholder: "e.g. LinkedIn newsletters, specific Slack communities, podcasts, industry conferences, certain publications.", required: false },
      { id: "warmRelationships", label: "Existing relationships who could introduce you to your target?", type: "textarea", placeholder: "People already in your network who have access to your ideal audience. Network leverage often beats content.", required: false },
      { id: "targetAudience",    label: "Other audiences you're trying to reach",                  type: "textarea",    placeholder: "e.g. PE partners at mid-market funds, CTOs at Fortune 500 retailers…", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      // S5-06 additions
      { id: "vulnerabilityComfort",  label: "Willing to share a professional failure publicly?",      type: "select",      options: ["Yes — vulnerability is part of my brand","Yes, with right framing — outcome focused","Rarely — only profound lessons","No — I prefer to project strength","Ask me case by case"], required: false },
      { id: "nervousTopics",         label: "Topics you have opinions on but feel nervous to say?",  type: "textarea",    placeholder: "Often your most powerful angles. Chanakya will surface them carefully. Be honest.", required: false },
      { id: "instantDeleteTriggers", label: "What would make you immediately delete a post?",          type: "textarea",    placeholder: "Beyond content taboos — tone, framing, or wording that would make you uncomfortable regardless of topic.", required: false },
  ...
  },
  {
    ...
    fields: [
      ...
      // S5-06 addition — critical for brand differentiation
      { id: "contrarianThesis",  label: "The ONE thing everyone in your industry gets wrong",            type: "textarea", placeholder: "Your cornerstone contrarian belief. The thing you'd stake your reputation on. 'Everyone talks about X but the real issue is Y.'", required: false },
  ...
  },
  {
    ...
    fields: [
      ...
      // S5-06 additions
      { id: "platformPreferences",  label: "Platforms you are comfortable being active on",           type: "multiselect", options: ["LinkedIn","X / Twitter","Instagram","YouTube","Podcast / Audio","Newsletter / Substack","TikTok","Threads"], required: false },
      { id: "platformsToAvoid",     label: "Platforms you will absolutely not use",                   type: "textarea",    placeholder: "Hard constraints. e.g. 'No TikTok — not appropriate for my audience' or 'No X — don't want the noise'.", required: false },
      { id: "videoComfort",         label: "Comfort with appearing on video",                         type: "select",      options: ["Yes — camera-ready, do it regularly","Yes with prep — I need a brief","Occasionally — major events only","Audio only (podcast) preferred","No video — strictly written content"], required: false },
      { id: "writingStyle",         label: "When you write, you tend to write...",                    type: "select",      options: ["Short punchy sentences. One idea per line.","Longer analytical paragraphs with structure","Question-led — I open loops and close them","Narrative storytelling arc","Data and evidence first, then interpretation","Mixed — depends on the topic"], required: false },
  ...
  },
  {
    ...
    fields: [
      ...
      // S5-06 additions
      { id: "competitiveWhitespace", label: "Angle nobody in your space is taking that you could own", type: "textarea",    placeholder: "The gap in your industry's content landscape. What's missing? What do peers not say that you could?", required: false },
      { id: "contentDislike",        label: "Content from peers you find shallow or overdone",         type: "textarea",    placeholder: "The LinkedIn clichés and content patterns that make you cringe. These are the gaps to exploit.", required: false },
  ...
  },
  {
    ...
    fields: [
      ...
      // S5-06 additions
      { id: "earlySignal",      label: "What would tell you in week 2 this is working?",      type: "textarea", placeholder: "The leading indicator. 'An inbound from someone I've never met' or 'A comment from a competitor's follower'.", required: false },
      { id: "linkedinFollowing",label: "Current LinkedIn following size",                     type: "select",   options: ["Under 500","500–2,000","2,000–5,000","5,000–10,000","10,000–25,000","25,000+"], required: false },
      { id: "currentEngagement",label: "Typical engagement on your LinkedIn posts",           type: "select",   options: ["0–5 likes per post","5–20 likes per post","20–100 likes per post","100–500 likes per post","500+ likes — significant reach already","I don't post currently"], required: false },
